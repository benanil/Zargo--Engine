...
namespace IconFonts
{
    ...
    {
        public static readonly ImFontPtr font;

        static FontAwesome5Brands()
        {
            font = ImGui.GetIO().Fonts.AddFontFromFileTTF(AssetManager.GetFileLocation(@"Fonts\FontAwsome\fa-brands-400.ttf"), 20);
        }
