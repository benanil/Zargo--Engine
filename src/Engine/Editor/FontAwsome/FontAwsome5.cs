...
namespace IconFonts
{
    public class FontAwesome5
    {
        ...
        public unsafe static void Construct()
        {
            ...
            font = ImGui.GetIO().Fonts.AddFontFromFileTTF(AssetManager.GetFileLocation(@"Fonts\FontAwsome\fa-regular-400.ttf"),16, new ImFontConfigPtr(fontPtr), (IntPtr)(glyphPtr));
        }
